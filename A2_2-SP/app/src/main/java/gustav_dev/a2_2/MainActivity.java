...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sp = getSharedPreferences("freetext", MODE_PRIVATE);
        String freetext;
        freetext = sp.getString("freetext1","");
        ((EditText)findViewById(R.id.mult_text_1)).setText(freetext);
        freetext = sp.getString("freetext2","");
        ((EditText)findViewById(R.id.mult_text_2)).setText(freetext);
        freetext = sp.getString("freetext3","");
        ((EditText)findViewById(R.id.mult_text_3)).setText(freetext);
        freetext = sp.getString("freetext4","");
        ((EditText)findViewById(R.id.mult_text_4)).setText(freetext);
    ...
    */
    ...
    public void onDestroy() {
        ...
        EditText freetext;
        freetext = (EditText)findViewById(R.id.mult_text_1);
        e.putString("freetext1", freetext.getText().toString());
        freetext = (EditText)findViewById(R.id.mult_text_2);
        e.putString("freetext2", freetext.getText().toString());
        freetext = (EditText)findViewById(R.id.mult_text_3);
        e.putString("freetext3", freetext.getText().toString());
        freetext = (EditText)findViewById(R.id.mult_text_4);
        e.putString("freetext4", freetext.getText().toString());
        e.apply();
    }
